...
module.exports = {
    ...
    bot: {
        ...
        supportServer: process.env.SUPPORT_SERVER || 'https://discord.gg/7FMt59Urx7',
        website: process.env.WEBSITE || 'https://github.com/zeeinz-ux/HHMusicBOT',
    ...
    ytdl: {
        ...
        poToken: (process.env.YOUTUBE_PO_TOKEN || process.env.PO_TOKEN || '').trim() || null, // YouTube PO Token (sunucu IP'leri için)
